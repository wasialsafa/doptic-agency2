    ...
    useEffect(() => {
        ...
        let ctx = gsap.context(() => {
            ...
            mm.add("(min-width: 1024px)", () => {
                ...
                // UPDATED: Added * 1.05 to scale it slightly larger than the screen width.
                // This ensures the right side gap is completely covered even if calculations are off by a few pixels.
                const targetWidth = window.innerWidth * 1.05
            ...
            mm.add("(max-width: 1023px)", () => {
                ...
                // 2. Image stays pinned (scales to fill width more)
                ...
                .fromTo(bottomLeftRef.current, 
                    ...
                    { 
                        ...
                        duration: 1.5, 
                        ease: "power1.in",
                        onComplete: () => gsap.to(bottomLeftRef.current, { opacity: 0, duration: 0.2 }) 
                    }, 
                    0.1 
                )
            })
            ...
            <div className="w-full max-w-[1290px] mx-auto px-5 lg:px-0 relative">
                ...
                <div ref={topTextRef} className="mb-12 lg:mb-[200px] will-change-transform relative z-20">
                    <h1 className="text-[#0e0e0e] dark:text-[#e2e2e2] text-4xl md:text-6xl lg:text-[128px] xl:text-[128px]"
                        style={{ fontFamily: '"Inter", sans-serif', fontWeight: 500, lineHeight: '120%', letterSpacing: '-0.04em' }}>
                ...
                <div ref={bottomRowRef} className="flex flex-col-reverse lg:flex-row gap-12 lg:gap-[140px] items-start relative">
                    ...
                    <div ref={bottomLeftRef} className="w-full lg:w-[520px] lg:min-w-[520px] will-change-transform z-30 relative">
                        <p className="text-base md:text-xl text-[#0E0E0E]/70 dark:text-[#e2e2e2]/70 mb-8 lg:mb-[56px]" 
                           style={{ fontFamily: '"Inter", sans-serif', fontWeight: 400, lineHeight: '150%', fontSize: '18px' }}>
                    ...
                    <div className="w-full lg:w-[630px] flex justify-end items-center z-10 relative">
                        <div ref={imageContainerRef} className="relative w-full aspect-video lg:w-[630px] lg:h-[352px] will-change-transform">
                            {/* Ensured no shadow class is present */}
                            <div ref={innerImageRef} className="image-container overflow-hidden w-full h-full bg-black">
                                <video 
