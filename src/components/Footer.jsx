    ...
    <footer className="w-full bg-bg-light dark:bg-bg-dark flex flex-col relative overflow-hidden">
      ...
      <div className="w-full max-w-[1440px] mx-auto pt-[80px] md:pt-[120px] px-6 md:px-[75px] pb-[20px] flex flex-col gap-[64px]">
        ...
        <div className="w-full flex flex-col lg:flex-row items-start">
          ...
          <div className="flex flex-wrap md:flex-nowrap items-start gap-8 flex-1 w-full lg:max-w-[730px]">
            ...
            <nav className="items-start gap-4 flex-1 flex flex-col min-w-[120px]">
              <h3 
                className="self-stretch font-medium text-text-dark dark:text-text-light text-xl md:text-2xl tracking-[-0.96px] leading-[28.8px]"
                style={{ fontFamily: '"Inter Variable", sans-serif' }}
              >
                Company
              </h3>
        ...
        <div className="w-full flex flex-col gap-[48px]">
          <h2 
            className="text-start self-stretch font-medium text-text-dark dark:text-text-light text-6xl md:text-8xl lg:text-[160px] tracking-[0] leading-tight md:leading-[1] lg:leading-[0.9]"
            style={{ fontFamily: '"Inter Variable", sans-serif' }}
          >
            Doptic
          </h2>
          ...
          <div className="w-full items-center gap-5 flex flex-col">
            ...
            <div className="flex items-center justify-center w-full text-center">
              <p 
                className="font-normal text-gray-700 dark:text-text-secondary text-sm md:text-base tracking-[0] leading-[25.6px] whitespace-normal md:whitespace-nowrap"
                style={{ fontFamily: '"Inter Variable", sans-serif' }}
              >
